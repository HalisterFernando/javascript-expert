...
const { argv: { componentName } } = yargs(hideBin(process.argv))
    .command('skeleton', 'create a project skeleton', (builder) => {
        return builder
            ...
            .example('skeleton -c product -c person -c colors', 'creates a project with a domain list')
        })
        .epilog('copyright 2024 - Halister Fernando Corporation');
